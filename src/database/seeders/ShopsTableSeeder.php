...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'img' => 'http://localhost/storage/shop-img/sushi.jpg',
        ];
        ...
        $param = [
            ...
            'img' => 'http://localhost/storage/shop-img/yakiniku.jpg',
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'img' => 'http://localhost/storage/shop-img/izakaya.jpg',
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'img' => 'http://localhost/storage/shop-img/italian.jpg',
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'img' => 'http://localhost/storage/shop-img/ramen.jpg',
        ];
        DB::table('shops')->insert($param);
