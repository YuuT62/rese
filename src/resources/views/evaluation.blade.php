            ...
            <table class="evaluation-content__table">
                <tr class="evaluation-content__row">
                    ...
                    <td class="evaluation-content__table-grade">
                        <label class="evaluation-content__grade-label" for="evaluation-grade-total-1">
                            <input class="evaluation-content__grade-input grade-1" type="radio" name="evaluation-grade-total" value=1 id="evaluation-grade-total-1" onchange="this.form.submit()" @if(@$_POST["evaluation-grade-total"] === '1') checked @endif>
                            @if(@$_POST["evaluation-grade-total"] >= 1)
                            <img class="evaluation-content__grade-icon--on grade-on-1" src="{{ asset('icon/grade_on_icon.png') }}" alt="grade_on_icon">
                            @endif
                            <img class="evaluation-content__grade-icon--off grade-off-1" src="{{ asset('icon/grade_off_icon.png') }}" alt="grade_off_icon">
                        </label>

                        <label class="evaluation-content__grade-label" for="evaluation-grade-total-2">
                            <input class="evaluation-content__grade-input grade-2" type="radio" name="evaluation-grade-total" value=2 id="evaluation-grade-total-2" onchange="this.form.submit()" @if(@$_POST["evaluation-grade-total"] === '2') checked @endif>
                            @if(@$_POST["evaluation-grade-total"] >= 2)
                            <img class="evaluation-content__grade-icon--on grade-on-2" src="{{ asset('icon/grade_on_icon.png') }}" alt="grade_on_icon">
                            @endif
                            <img class="evaluation-content__grade-icon--off grade-off-2" src="{{ asset('icon/grade_off_icon.png') }}" alt="grade_off_icon">
                        </label>

                        <label class="evaluation-content__grade-label" for="evaluation-grade-total-3">
                            <input class="evaluation-content__grade-input grade-3" type="radio" name="evaluation-grade-total" value=3 id="evaluation-grade-total-3" onchange="this.form.submit()" @if(@$_POST["evaluation-grade-total"] === '3') checked @endif>
                            @if(@$_POST["evaluation-grade-total"] >= 3)
                            <img class="evaluation-content__grade-icon--on grade-on-3" src="{{ asset('icon/grade_on_icon.png') }}" alt="grade_on_icon">
                            @endif
                            <img class="evaluation-content__grade-icon--off grade-off-3" src="{{ asset('icon/grade_off_icon.png') }}" alt="grade_off_icon">
                        </label>

                        <label class="evaluation-content__grade-label" for="evaluation-grade-total-4">
                            <input class="evaluation-content__grade-input grade-4" type="radio" name="evaluation-grade-total" value=4 id="evaluation-grade-total-4" onchange="this.form.submit()" @if(@$_POST["evaluation-grade-total"] === '4') checked @endif>
                            @if(@$_POST["evaluation-grade-total"] >= 4)
                            <img class="evaluation-content__grade-icon--on grade-on-4" src="{{ asset('icon/grade_on_icon.png') }}" alt="grade_on_icon">
                            @endif
                            <img class="evaluation-content__grade-icon--off grade-off-4" src="{{ asset('icon/grade_off_icon.png') }}" alt="grade_off_icon">
                        </label>

                        <label class="evaluation-content__grade-label" for="evaluation-grade-total-5">
                            <input class="evaluation-content__grade-input grade-5" type="radio" name="evaluation-grade-total" value=5 id="evaluation-grade-total-5" onchange="this.form.submit()" @if(@$_POST["evaluation-grade-total"] === '5') checked @endif>
                            @if(@$_POST["evaluation-grade-total"] >= 5)
                            <img class="evaluation-content__grade-icon--on grade-on-5" src="{{ asset('icon/grade_on_icon.png') }}" alt="grade_on_icon">
                            @endif
                            <img class="evaluation-content__grade-icon--off grade-off-5" src="{{ asset('icon/grade_off_icon.png') }}" alt="grade_off_icon">
                        </label>
                    </td>
                </tr>
