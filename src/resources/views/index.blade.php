...
<form class="search-box" action="/search" method="get">
    <div class="search-box__area">
        ...
        <img class="search-box__select-icon" src="{{ asset('icon/select_icon.png') }}" alt="select_icon">
    </div>
    ...
    <div class="search-box__search">
        <img class="search-box__search-icon" src="{{ asset('icon/search_icon.png') }}" alt="mail_icon">
        ...
        <div class="shop-info">
            ...
            <div class="shop-info__detail">
                ...
                <div class="shop-info__button">
                    <form class="shop-info__button--detail" action="/detail/{{$shop->id}}" method="get">
